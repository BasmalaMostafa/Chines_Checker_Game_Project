...
import company.GUI.GameState;
import company.GUI.Seed;

public class Simulation{
    double Max_time = 0.1;

    public static Seed[] crossId = { Seed.CROSS1, Seed.CROSS2, Seed.CROSS3, Seed.CROSS4, Seed.CROSS5,
            Seed.CROSS6, Seed.CROSS7, Seed.CROSS8, Seed.CROSS9,Seed.CROSS10};

    public static Seed[] noughtId = { Seed.NOUGHT1, Seed.NOUGHT2, Seed.NOUGHT3, Seed.NOUGHT4, Seed.NOUGHT5,
            Seed.NOUGHT6, Seed.NOUGHT7, Seed.NOUGHT8, Seed.NOUGHT9,Seed.NOUGHT10,};
    ...
    private Node runSim(Seed[][] gaming, Node rootNode) {
        ...
        while (System.currentTimeMillis() - start < (Max_time*1000)) {

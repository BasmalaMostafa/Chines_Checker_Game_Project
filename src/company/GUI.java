...
public  class GUI extends JFrame{
    ...
    public enum Seed {
        EMPTY,  CROSS, CROSS1, CROSS2, CROSS3, CROSS4, CROSS5, CROSS6, CROSS7, CROSS8, CROSS9, CROSS10,
        NOUGHT, NOUGHT1, NOUGHT2, NOUGHT3, NOUGHT4, NOUGHT5, NOUGHT6, NOUGHT7, NOUGHT8, NOUGHT9, NOUGHT10, CONSIDERED, ILLEGITIMATE
    }

    public static Seed[] crossId = {Seed.CROSS10, Seed.CROSS1, Seed.CROSS2, Seed.CROSS3, Seed.CROSS4, Seed.CROSS5,
            Seed.CROSS6, Seed.CROSS7, Seed.CROSS8, Seed.CROSS9};

    public static Seed[] noughtId = {Seed.NOUGHT10, Seed.NOUGHT1, Seed.NOUGHT2, Seed.NOUGHT3, Seed.NOUGHT4, Seed.NOUGHT5,
    ...
    public GUI() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (currentState == GameState.PLAYING) {
                    if(firstClick) {
                        ...
                        if (move(moves, rowSelected, colSelected)) {
                            ...
                            if (currentState == GameState.PLAYING) {
                                pieceMove = Moves(pieceMove, firstMove, finalMove);
                            }
                        }
                        pieceMoved = Seed.ILLEGITIMATE;
                        firstClick = true;
        ...
        statusBar.setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));
    ...
    public boolean move(ArrayList<Integer> moves, int rowSelected, int colSelected) {
    ...
    public Node Moves(Node moveNode, int[] moveFirst, int[] moveLast) {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (currentState == GameState.PLAYING) {
                ...
                if (currentPlayer == Seed.CROSS) {
                    statusBar.setText("Play");
                } else {
                    statusBar.setText("Computer's Turn");
                }
            } else if (currentState == GameState.CROSS_WON) {
                statusBar.setForeground(Color.RED);
                statusBar.setText("u Won! Click to play again.");
